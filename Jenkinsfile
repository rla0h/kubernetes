        ...
        stage('Apply Source') {
            steps {
                script {
                    ...
                    sh "kubectl cp ${pub_source} ${podName}:../NWT/src/hello.java"
                    sh "kubectl exec -it ${podName} -- sh -c 'javac -cp classes:/DDS/NWT/lib/*:/DDS/NWT/bin:classes ../NWT/src/hello.java"
